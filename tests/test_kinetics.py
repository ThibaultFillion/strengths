...
def _test_compute_reaction_rates_value(spacetype) :
...
def _test_compute_reaction_rates_with_environments(spacetype) :
...
def _test_compute_reaction_rates_in_inhomogeneous_state(spacetype) :
    #checks that reaction env are taken into account
...
def _test_compute_diffusion_rates(spacetype) :
...
def _test_compute_diffusion_rates_with_different_env(spacetype) :
...
def _test_compute_diffusion_rates_with_different_units(spacetype) :
...
def _test_compute_dspeciesdt(spacetype) :
...
def test_compute_reaction_rates_dimensions_for_different_reaction_orders_with_default_units_default_units__graph():
    _test_compute_reaction_rates_dimensions_for_different_reaction_orders_with_default_units_default_units("graph")

def test_compute_reaction_rates_value__graph():
    _test_compute_reaction_rates_value("graph")

def test_compute_reaction_rates_with_environments__graph():
    _test_compute_reaction_rates_with_environments("graph")

def test_compute_reaction_rates_in_inhomogeneous_state__graph():
    _test_compute_reaction_rates_in_inhomogeneous_state("graph")

def test_compute_diffusion_rates__graph():
    _test_compute_diffusion_rates("graph")

def test_compute_diffusion_rates_with_different_env__graph():
    _test_compute_diffusion_rates("graph")

def test_compute_diffusion_rates_with_different_units__graph():
    _test_compute_diffusion_rates_with_different_units("graph")

def test_compute_dspeciesdt__graph():
    _test_compute_dspeciesdt("graph")

#####################################
# grid versions

def test_compute_reaction_rates_dimensions_for_different_reaction_orders_with_default_units_default_units__grid():
    _test_compute_reaction_rates_dimensions_for_different_reaction_orders_with_default_units_default_units("grid")

def test_compute_reaction_rates_value__grid():
    _test_compute_reaction_rates_value("grid")

def test_compute_reaction_rates_with_environments__grid():
    _test_compute_reaction_rates_with_environments("grid")

def test_compute_reaction_rates_in_inhomogeneous_state__grid():
    _test_compute_reaction_rates_in_inhomogeneous_state("grid")

def test_compute_diffusion_rates__grid():
    _test_compute_diffusion_rates("grid")

def test_compute_diffusion_rates_with_different_env__grid():
    _test_compute_diffusion_rates("grid")

def test_compute_diffusion_rates_with_different_units__grid():
    _test_compute_diffusion_rates_with_different_units("grid")
